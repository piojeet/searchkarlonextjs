    ...
    return (
        <div className="sm:space-y-4 sm:my-4">
            <div className="flex items-center gap-2 flex-wrap">
                ...
                <div className="font-semibold lg:text-lg flex items-center gap-1 text-[#4B51A7]">Change Variant <CircleChevronDown size={16} /></div>
            ...
            <div className="sm:flex items-center gap-2 flex-wrap text-sm space-y-2 sm:space-y-0">
                <div className="font-semibold text-lg sm:flex hidden items-center gap-1 text-[#4B51A7]">Change Variant <CircleChevronDown size={16} /></div>
